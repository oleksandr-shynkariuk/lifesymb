...
require( NTS_BASE_DIR . '/lib/form/inputs/hidden.php' );
...
switch( $inputAction ){
	case 'display':
		...
		$deleteHtml = '&nbsp;<a class="alert nts-bold ' . $deleteClass . '" href="#" title="' . M('Delete') . '">[x]</a>';
		...
		$input .= '<a class="nts-ok nts-button2" href="#" id="' . $addId . '" gldp-id="' . $addId . '">';
		$input .= '[+] ' . M('Add');
		$input .= '</a>';
