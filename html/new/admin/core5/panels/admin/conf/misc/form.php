...
<tr>
	<td class="ntsFormLabel"><?php echo M('Show Session Duration For Clients'); ?></td>
	<td class="ntsFormValue">
	<?php
	echo $this->makeInput (
	/* type */
...
<tr>
	<td class="ntsFormLabel"><?php echo M('Show Appointment End Time For Clients'); ?></td>
	<td class="ntsFormValue">
	<?php
	echo $this->makeInput (
	/* type */
...
<tr>
	<td class="ntsFormLabel"><?php echo M('Selection Display Style'); ?></td>
	<td class="ntsFormValue">
	<?php
	$selectOptions = array(
		array( 'list', M('List') ),
